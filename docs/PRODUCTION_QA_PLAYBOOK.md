...
- Lint/type gates should pass, allowing only documented non-blocking warnings.
- Production-affecting builds should pass.
- Backend contract checks should pass or produce a linked residual issue with
