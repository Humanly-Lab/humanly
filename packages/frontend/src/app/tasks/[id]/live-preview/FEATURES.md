...
## Page Location
`/home/ubuntu/humanly/packages/frontend/src/app/(dashboard)/tasks/[id]/live-preview/page.tsx`
...
1. **Main Page**: `/app/(dashboard)/tasks/[id]/live-preview/page.tsx` (729 lines)
2. **Badge Component**: `/components/ui/badge.tsx`
3. **ScrollArea Component**: `/components/ui/scroll-area.tsx`
4. **Documentation**: `/app/(dashboard)/tasks/[id]/live-preview/README.md`
5. **Feature Summary**: `/app/(dashboard)/tasks/[id]/live-preview/FEATURES.md`
